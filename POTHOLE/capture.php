    ...
    if(isset($_GET['lat']) && isset($_GET['lon'])) {
        ...
        echo "<script>
                ...
                function showPosition(position) {
                    window.location.href = 'capture.php?lat=' + position.coords.latitude + '&lon=' + position.coords.longitude;
               }
            </script>";
    }
?>
...
if(isset($_POST["submit"]))
{
		...
		$latitude = $_GET['lat'];
		$longitude = $_GET['lon'];
		$sql = mysqli_query($conn,"INSERT INTO reports(contact,img_id,latitude,longitude) 
		VALUES('$cont','$img_id','$latitude','$longitude')");
		if($sql === TRUE)
		{
